...
--
-- Host: 127.0.0.1
-- Generation Time: May 02, 2025 at 07:36 PM
...
(1, 1, 'Kickoff Meeting', '2025-05-01', 'Initial meeting with stakeholders.', 1),
...
(5, 2, 'Email Blast', '2025-05-20', 'Send marketing emails to subscribers.', 0),
(6, 3, 'Doctor Appointment', '2025-05-02', 'Routine checkup at 10:00 AM.', 0),
(7, 3, 'Gym Session', '2025-05-03', 'Leg day workout.', 0),
(8, 1, 'dd', '2025-05-01', 'ghfgfg', 1),
(9, 1, 'jkgjkgkj', '2025-05-13', 'hkjh', 0);
...
--
ALTER TABLE `users_calendars`
  ADD CONSTRAINT `users_calendars_ibfk_1` FOREIGN KEY (`calendar_id`) REFERENCES `calendars` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `users_calendars_ibfk_2` FOREIGN KEY (`user_id`) REFERENCES `users` (`user_id`) ON DELETE CASCADE,
  ADD CONSTRAINT `users_calendars_ibfk_3` FOREIGN KEY (`role_id`) REFERENCES `roles` (`id`) ON DELETE CASCADE;
COMMIT;
